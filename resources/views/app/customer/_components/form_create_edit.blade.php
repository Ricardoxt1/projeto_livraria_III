<form class="needs-validation" method="post" id="costumerForm" novalidate="">
    <div class="row g-3">
        <div class="col-sm-6">
        ...
        <div class="col-sm-4">
            ...
            <input type="number" class="form-control" name="phone_number" id="validationCustom02"
                placeholder="00 00000000" maxlength="14" required="">
            <div class="valid-feedback">
                Telefone preenchido!
            </div>
            <div class="invalid-feedback">
