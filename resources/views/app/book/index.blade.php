                                ...
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body p-4">
                                        @foreach ($books as $book)
                                            <p class="card-text">Titulo: {{ $book->titule }}</p>
                                            <p class="card-text">Páginas: {{$book->page}}</p>
                                            <p class="card-text">Lançamento: {{$book->realese_date}}</p>
                                            <p class="card-text">Autor(a): {{ $book->author->name }}</p>
                                            <p class="card-text">Editora: {{ $book->publisher->name }}</p>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="btn-group m-1">
                                                    <a class="m-2" href="{{ route('book.create', $book->id) }}"><svg xmlns="http://www.w3.org/2000/svg"
