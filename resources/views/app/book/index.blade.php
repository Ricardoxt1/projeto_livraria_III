<main class="col-md-9 ms-sm col-lg-10 px-md-5">
    ...
    <div class="card shadow-sm">
        <svg class="bd-placeholder-img card-img-top" width="70%" height="300" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group m-1">
                    <a class="m-2" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="22"
                            height="22" fill="currentColor" class="bi bi-pencil-square text-success"
                            viewBox="0 0 16 16">
                            <path
