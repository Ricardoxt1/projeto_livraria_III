 <form class="needs-validation" id="bookForm" method="post" action="" novalidate="">
     <div class="row g-3">
         <div class="col-sm-6">
             ...
             <input type="text" class="form-control" name="titule" id="validationCustom01"
                 placeholder="A bela e a fera" value="" required>
         ...
         <div class="col-sm-3">
             <label for="validationCustom03" class="form-label">Data de
                 lançamento</label>
             <input type="number" min="1800" id="validationCustom03" name="realese_date" max=""
                 step="1" class="form-control" placeholder="1800" value="" required>
             <div class="valid-feedback">
         ...
         <div class="mb-3">
             <input type="file" class="form-control" aria-label="file example" name="img" accept="image/*"
                 required>
